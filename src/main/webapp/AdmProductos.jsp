                                ...
                                <tbody class="cuerpo-tabla-admproductos">
                                    <c:forEach var="producto" items="${listaProducto}">
                                        <tr class="fila-cuerpo-tabla-admproductos">
                                            ...
                                            <td class="cuadro-cuerpo-tabla-admproductos">${producto.categoria.nombre}</td>
                                            <td class="cuadro-cuerpo-tabla-admproductos">${producto.proveedor.nombre}</td>
                                            <td class="acciones-cuerpo-tabla-admproductos">
                                                <input type="button" value="Editar" class="btn-editar-admproductos">
